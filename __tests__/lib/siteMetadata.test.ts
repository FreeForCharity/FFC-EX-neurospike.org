...
describe('social card', () => {
  // Issue #23: the card used to be the 512x512 app icon under a
  // `summary_large_image` twitter:card, a combination no platform renders as
  // intended. These assertions are what keep it from drifting back.
  const image = (
